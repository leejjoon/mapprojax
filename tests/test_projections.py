...
class TestProjections(unittest.TestCase):
    def test_tan_roundtrip(self):
        ...
        self.assertAlmostEqual(ra, 45.0)
        ...
        self.assertAlmostEqual(x_res, x_target)
        self.assertAlmostEqual(y_res, y_target)
    ...
    def test_tan_array_broadcasting(self):
        ...
        self.assertEqual(x_bc.shape, (3,))
        self.assertAlmostEqual(x_bc[0], 100.0)
        self.assertNotEqual(x_bc[1], 100.0)
        ...
        self.assertEqual(x_cart.shape, (2, 3))
        
        # (0, 0): Point 0 (45) vs WCS 0 (45) -> 100
        self.assertAlmostEqual(x_cart[0, 0], 100.0)
        # (1, 2): Point 1 (55) vs WCS 2 (55) -> 100
        self.assertAlmostEqual(x_cart[1, 2], 100.0)
    ...
    def test_singular_cd_error(self):
